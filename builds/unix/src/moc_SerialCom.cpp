/****************************************************************************
** Meta object code from reading C++ file 'SerialCom.hpp'
**
...
#include "../../../src/SerialCom.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'SerialCom.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 8), // "response"
...
QT_MOC_LITERAL(5, 28, 7) // "timeout"
    ...
    "SerialCom\0response\0\0s\0error\0timeout"
};
...
void SerialCom::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SerialCom::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialCom::response)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SerialCom::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialCom::error)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (SerialCom::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialCom::timeout)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject SerialCom::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_SerialCom.data,
...
// SIGNAL 0
void SerialCom::response(const QString & _t1)
{
...
// SIGNAL 1
void SerialCom::error(const QString & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void SerialCom::timeout(const QString & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
