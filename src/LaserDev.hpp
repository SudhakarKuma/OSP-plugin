...
private:
	...
	*/
    ...
    QString step_x;
      ...
      /**
      *    Constant string for sending number of x steps 
      */
    ...
    QString step_y;
      ...
      /**
      *    Constant string for sending number of y steps for motor
      */
...
/**
	*	Constant double for x degree steps.
	*/
    double dx;

	/**
	*	Constant double for y degree steps.
	*/
	double dy;
...
public slots:
	...
	*/
	...
	/**
	*	To move the laser in x direction x steps right or left
	*/
    void stepx(double x,double y);

	/**
	*	To move the laser in y direction y steps forward or backward
	*/
    void stepy(QString y);
