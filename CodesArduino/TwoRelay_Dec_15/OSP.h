...
class OSP{
     ...
     bool dir; 
			 ...
			 */
			bool _moveXY(float x, float y, bool nodelay=false);
...
void setMotorsPins(int step1, int dir1, int enable1, int step2, int dir2, int enable2);
			...
			bool movx(bool dir,  int step1, int dir1, float x_step, bool text);
			/**
     ...
     bool movy(bool dir,  int step2, int dir2, float y_step, bool text);
