...
public slots:
	...
	*/
	...
	/**
	*	This functions is called when the buttons Up(mvUp) is released
	*/
	void upReleased();
	/**
	*	This functions is called when the buttons Up(mvUp) is released
	...
	*/
    void leftPressed();
	/**
	*	This function is connected to the Ok button and sends the x,y degrees from UI to the controller
	*/
    void nStepClicked();
